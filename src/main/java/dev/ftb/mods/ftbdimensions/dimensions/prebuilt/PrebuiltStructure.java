...
public record PrebuiltStructure(ResourceLocation id, ResourceLocation structureLocation, Component name, String author, ResourceLocation structureSetId, int height) {
    ...
    public static PrebuiltStructure fromJson(JsonElement element) {
        ...
        return new PrebuiltStructure(id, structureLocation, name, author, structureSetId, height);
    }
