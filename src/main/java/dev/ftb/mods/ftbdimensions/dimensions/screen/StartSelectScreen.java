...
public class StartSelectScreen extends Screen {
	...
	protected void init() {
		...
		this.addRenderableWidget(new Button(this.width / 2 - 130, this.height - 30, 100, 20, Component.translatable("screens.ftbdimensions.back"), btn -> onClose()));

		this.addRenderableWidget(this.createButton = new Button(this.width / 2 - 20, this.height - 30, 150, 20, Component.translatable("screens.ftbdimensions.create"), btn -> {
	...
	public void render(PoseStack matrices, int mouseX, int mouseY, float partialTick) {
		...
		String value = Component.translatable("screens.ftbdimensions.select_start").getString();
	...
	public class StartList extends AbstractSelectionList<StartList.Entry> {
		...
		public class Entry extends AbstractSelectionList.Entry<Entry> {
			...
			public void render(PoseStack matrices, int entryId, int top, int left, int entryWidth, int entryHeight, int mouseX, int mouseY, boolean bl, float partialTicks) {
				...
				font.drawShadow(matrices, Component.translatable("screens.ftbdimensions.by", this.islandDir.author()), startX, top + 26, 0xD3D3D3);
